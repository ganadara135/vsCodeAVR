...
int main(void)
{
	initTests(__FILE__);   // __FILE_  º» ÆÄÀÏ aes.c
	
	//initTests("init_test.txt");
	scanTestVectors("test_vectors/ECBVarTxt128.rsp");
	scanTestVectors("test_vectors/ECBVarKey128.rsp");
	scanTestVectors("test_vectors/ECBKeySbox128.rsp");
	scanTestVectors("test_vectors/ECBGFSbox128.rsp");
